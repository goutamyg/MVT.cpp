...
void track(MVT *tracker, const char *video_path)
{
    ...
    for (const auto& imagePath : imageFiles) {
        ...
        if (isFirstImage){
            ...
            std::cout << "Start tracker initialization ..." << std::endl;
            std::cout << "==========================" << std::endl;
            MVT_output bbox;
            ...
            std::cout << "==========================" << std::endl;
            std::cout << "Tracker initialization done!" << std::endl;
            std::cout << std::endl;
            isFirstImage = false;
        }
        else{
            ...
            std::cout << "[x, y, w, h]: [" << rect.x << " " << rect.y << " " << rect.width << " " << rect.height << "]" << std::endl;
